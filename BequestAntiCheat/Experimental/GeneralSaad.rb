module Saad
  class Competitive
    ...
    def self.evaluate_player
      ...
      training = [
        [0.0010,    "None #{@player_attribute} #{@player_mechanic}"],
        [0.2505,    "Some #{@player_attribute} #{@player_mechanic}"],
        [0.5000,    "Mild #{@player_attribute} #{@player_mechanic}"],
        [0.7495,  "Medium #{@player_attribute} #{@player_mechanic}"],
        [0.9990,    "High #{@player_attribute} #{@player_mechanic}"],
      ]
    ...
    def self.evaluate_gribatomaton
      ...
      training = [
        [0.0010,    "None #{@gribatomaton_attribute} #{@gribatomaton_mechanic}"],
        [0.2505,    "Some #{@gribatomaton_attribute} #{@gribatomaton_mechanic}"],
        [0.5000,    "Mild #{@gribatomaton_attribute} #{@gribatomaton_mechanic}"],
        [0.7495,  "Medium #{@gribatomaton_attribute} #{@gribatomaton_mechanic}"],
        [0.9990,    "High #{@gribatomaton_attribute} #{@gribatomaton_mechanic}"],
      ]
    ...
    def self.evaluate_enemy
      ...
      training = [
        [0.0010,    "None #{@enemy_attribute} #{@enemy_mechanic}"],
        [0.2505,    "Some #{@enemy_attribute} #{@enemy_mechanic}"],
        [0.5000,    "Mild #{@enemy_attribute} #{@enemy_mechanic}"],
        [0.7495,  "Medium #{@enemy_attribute} #{@enemy_mechanic}"],
        [0.9990,    "High #{@enemy_attribute} #{@enemy_mechanic}"],
      ]
